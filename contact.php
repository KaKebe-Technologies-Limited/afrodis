                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <h1 class="display-1 text-white mb-5 animated slideInDown">Lorem ipsum dolor sit amet.
                                    </h1>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod doloremque eos ad saepe illum esse excepturi rerum. Mollitia, saepe possimus. <a href="https://htmlcodex.com/contact-form">Download Now</a>.</p>
                    <form>
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <button class="btn  py-3 px-4" style="background-color:rgb(255, 122, 138);color:white;" type="submit">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                   ...
                   <h4 class="text-white mb-4">Our Office</h4>
                    ...
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@afrodisworld.com</p>
